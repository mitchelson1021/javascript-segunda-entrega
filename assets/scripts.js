const signos = ["Aries", "Taurus", "Géminis", "Cáncer", "Leo", "Virgo", "Libra", "Eescorpio", "Sagitarius", "Capriconio", "Acuario", "Pisis"]
...
function zodiaco () {
    ...
    function fechaNacimiento (signo) {
        let textMensaje = document.createElement("h2");
        textMensaje.innerHTML = "Si tu fecha de Nacimiento es " + dia.value + "/" + mes.value + "/" + año.value + "  tu signo del Zodiaco es " +(signo);
